...
static void
write_SOI( struct c63_common *cm )
{
...
static void
write_DQT( struct c63_common *cm )
{
...
static void
write_SOF0( struct c63_common *cm )
{
...
static void
write_DHT_HTS( struct c63_common *cm, uint8_t id, uint8_t *numlength,
               uint8_t *data )
{
...
/* Define Huffman Table (DHT) marker, the payload is the Huffman table
   specifiation. */
static void
write_DHT( struct c63_common *cm )
{
...
static void
write_SOS( struct c63_common *cm )
{
...
static void
write_EOI( struct c63_common *cm )
{
    put_byte( cm->e_ctx.fp, JPEG_DEF_MARKER );
...
static void
write_block( struct c63_common *cm, int16_t *in_data, uint32_t width,
...
static void
write_interleaved_data_MCU( struct c63_common *cm, int16_t *dct,
...
static void
write_interleaved_data( struct c63_common *cm )
{
...
void
write_frame( struct c63_common *cm )
{
    /* Write headers */
